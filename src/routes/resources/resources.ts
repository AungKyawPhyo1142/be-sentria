...
router.post('/create', secureRoute(), upload.array('resourceImages', 5), resourceController.CreateResource);
router.patch('/update/:id', secureRoute(), upload.array('resourceImages', 5), resourceController.UpdateResource);
